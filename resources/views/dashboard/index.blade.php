    ...
    >
        ...
        <div class="py-4 text-gray-500 dark:text-gray-400">
          ...
          <ul>
            <li class="relative px-6 py-3">
              <a
                class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                href="{{route('dashboard/create-campagin')}}"
              >
                <svg
                  class="w-5 h-5"
                  aria-hidden="true"
                ...
                <span class="ml-4">Create campagin</span>
              </a>
            </li>
            <li class="relative px-6 py-3">
              <a
            ...
            <li class="relative px-6 py-3">
              ...
              >
                ...
                <span class="ml-4">Create employee</span>
              </a>
            </li>
            <li class="relative px-6 py-3">
      ...
      <div class="flex flex-col flex-1">
        <header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
          <div
            class="container flex items-center justify-between h-full px-6 mx-auto text-green-300 dark:text-green-100"
          >
            <!-- Mobile hamburger -->
            <button
            ...
            <div class="flex justify-center flex-1 lg:mr-32">
              <ul class="flex  ">
                <li class="mr-20 font-semibold text-black">
                <a href="{{url('/')}}"> الرئيسية</a>
                </li>
               <li class=" font-semibold text-black">
                <a href="{{route('campaigns.index')}}"> الحملات</a>
               </li></ul>
             
            </div>
            <ul class="flex items-center flex-shrink-0 mr-14">
              <!-- Profile menu -->
              
              
              <li class="relative">
                <button
                  class="align-middle rounded-full focus:shadow-outline-green bg-green-100 focus:outline-none"
                ...
                >
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" class=" object-cover sm:w-12 sm:h-12 h-8 w-8 rounded-full ionicon" viewBox="0 0 512 512"><path d="M258.9 48C141.92 46.42 46.42 141.92 48 258.9c1.56 112.19 92.91 203.54 205.1 205.1 117 1.6 212.48-93.9 210.88-210.88C462.44 140.91 371.09 49.56 258.9 48zm126.42 327.25a4 4 0 01-6.14-.32 124.27 124.27 0 00-32.35-29.59C321.37 329 289.11 320 256 320s-65.37 9-90.83 25.34a124.24 124.24 0 00-32.35 29.58 4 4 0 01-6.14.32A175.32 175.32 0 0180 259c-1.63-97.31 78.22-178.76 175.57-179S432 158.81 432 256a175.32 175.32 0 01-46.68 119.25z"/><path d="M256 144c-19.72 0-37.55 7.39-50.22 20.82s-19 32-17.57 51.93C191.11 256 221.52 288 256 288s64.83-32 67.79-71.24c1.48-19.74-4.8-38.14-17.68-51.82C293.39 151.44 275.59 144 256 144z"/></svg>
